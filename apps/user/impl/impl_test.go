...
func TestConstructUser_Integration(t *testing.T) {
	...
	require.NotEmpty(t, userObj.Name, "Name should not be empty")
	require.NotEmpty(t, userObj.Company, "Company should not be empty")
	require.NotEmpty(t, userObj.Location, "Location should not be empty")
	require.NotEmpty(t, userObj.Email, "Email should not be empty")
	require.NotEmpty(t, userObj.Bio, "Bio should not be empty")
	require.NotEmpty(t, userObj.Organizations, "Organizations should not be empty")
	require.GreaterOrEqual(t, userObj.Followers, 0, "Followers count should be non-negative")
	require.NotEmpty(t, userObj.Readme, "Readme should not be empty")
	require.NotEmpty(t, userObj.Commits, "Commits should not be empty")
